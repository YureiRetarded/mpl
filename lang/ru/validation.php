...
return [
    ...
    */
    ...
    'accepted_if' => 'Атрибут :attribute  должен быть принят, если :other равно :value.',
    'active_url' => 'Не является URL.',
    'after' => ':attribute должен быть датой и быть после :date.',
    'after_or_equal' => ':attribute должен быть датой и быть после или равной :date.',
    'alpha' => 'Должен содержать только буквы.',
    'alpha_dash' => 'Должен содержать только буквы, цифры, дефисы и символы подчеркивания.',
    'alpha_num' => 'Должен содержать только буквы и цифры.',
    ...
    'digits' => ':attribute должен быть цифрой.',
    ...
    'lowercase' => 'Должен быть в нижнем регистре.',
    'lt' => [
        ...
        'string' => 'T:attribute должен быть меньше :value символов.',
    ],
    'lte' => [
    ...
    'min_digits' => 'Должен содержать не менее :min цифр.',
    ...
    'uppercase' => 'Должен быть в верхнем регистре.',
    'url' => 'Должен быть URL.',
